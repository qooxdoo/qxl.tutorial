  ...
  qx.Class.define("qxl.tutorial.Application", {
    ...
    members: {
      ...
      main: function main() {
        ...
        mainComposite.add(this.__header); // create the content
      ...
      openSelectionWindow: function openSelectionWindow() {
        if (!this.__selectionWindow) {
          this.__selectionWindow = new qxl.tutorial.view.SelectionWindow(this.__desktopTutorials, this.__mobileTutorials);
      ...
      __onChangeTutorial: function __onChangeTutorial(e) {
      ...
      run: function run() {
        var code = this.__editor.getCode(); // don't run if we have no code
      ...
      loadTutorial: function loadTutorial(name, type) {
        ...
        req.addListener("success", function (e) {
          ...
          this.__description.setTutorial(this.parseTutorial(name, type, req.getResponse()));
...
//# sourceMappingURL=Application.js.map?dt=1588102305610