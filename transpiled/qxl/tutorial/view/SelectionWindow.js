(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.tutorial.view.SelectionWindow", {
    ...
    members: {
      __buttonFont: null,
      __createButton: function __createButton(name, desc) {
      ...
      __buildSelection: function __buildSelection(desktopTutorials, mobileTutorials) {
        var i = 0;
        ...
        for (key in mobileTutorials) {
          ...
          var _button = this.__createButton(_name, _desc);
...
//# sourceMappingURL=SelectionWindow.js.map?dt=1588102305913